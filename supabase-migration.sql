...
CREATE TABLE IF NOT EXISTS training_resources (
  ...
  type TEXT NOT NULL DEFAULT 'link' CHECK (type IN ('pdf', 'link', 'download', 'guide')),
...
CREATE INDEX IF NOT EXISTS idx_training_resources_video ON training_resources(video_id);
CREATE INDEX IF NOT EXISTS idx_training_progress_user ON training_user_progress(user_id);

-- Seed default videos (7 days x 3 videos)
